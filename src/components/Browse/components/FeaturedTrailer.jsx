...
export const FeaturedTrailer = () => {
    ...
    return (
        <div className="w-full overflow-hidden aspect-video h-[710px]">
            <iframe
                width="100%"
                height="auto"
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-black to-transparent opacity-100 aspect-video"></div>

            <div className="relative z-10 text-white mx-auto flex flex-col h-auto top-[20%] w-[80%] gap-5">
                <div className="w-[50%]">
                    ...
                    <div className="mt-7 flex gap-4">
                        <Buttons
                            ...
                            width="w-auto"
                            textStyle="rounded text-black font-bold flex-row-reverse"
                            icon={<FaPlay size={24} />}
                            type="submit"
                        ...
                        <Buttons
                            ...
                            type="submit"
                            bgColor="bg-gray-500 text-white bg-opacity-70 hover:bg-gray-500"
                        />
                    </div>
                </div>
